...
ActiveRecord::Schema.define(version: 2021_04_26_235027) do
  ...
  create_table "contributions", force: :cascade do |t|
    ...
    t.index ["customer_id"], name: "index_contributions_on_customer_id"
  end
  ...
  add_foreign_key "contributions", "customers"
end
